package io.github.jmeq17.mbglearn.mybatis3dynamicsql;

import io.github.jmeq17.mbglearn.mybatis3dynamicsql.entity.Student;
import io.github.jmeq17.mbglearn.mybatis3dynamicsql.mapper.StudentMapper;
...
public class TestGeneratedCode {
    ...
    static {
        try {
            // 加载 MyBatis 配置文件
            InputStream inputStream = Resources.getResourceAsStream("mybatis3dynamicsql/mybatis-config.xml");
    ...
    public void testStudengMapper() {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            // 查询用户
            Optional<Student> student = studentMapper.selectByPrimaryKey(1);// 假设查询 ID 为 1 的用户
            System.out.println(student.orElseThrow().getName());    // 张三
