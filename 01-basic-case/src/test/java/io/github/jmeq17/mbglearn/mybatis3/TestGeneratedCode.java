package io.github.jmeq17.mbglearn.mybatis3;

import io.github.jmeq17.mbglearn.mybatis3.entity.Student;
import io.github.jmeq17.mbglearn.mybatis3.mapper.StudentMapper;
...
public class TestGeneratedCode {
    ...
    static {
        try {
            // 加载 MyBatis 配置文件
            InputStream inputStream = Resources.getResourceAsStream("mybatis3/mybatis-config.xml");
